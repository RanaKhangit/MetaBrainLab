...
export default function sitemap(): MetadataRoute.Sitemap {
  const baseUrl = "https://metabrainlabs.com";
  ...
  return [
    ...
    { url: `${baseUrl}/ethics`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${baseUrl}/investor-access`, lastModified: new Date(), changeFrequency: "yearly", priority: 0.4 },
